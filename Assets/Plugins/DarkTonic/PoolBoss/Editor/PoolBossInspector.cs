...
public class PoolBossInspector : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (isInProjectView) {
			DTPoolBossInspectorUtility.ShowRedError("You have selected the PoolBoss prefab in Project View. Please select the one in your Scene to edit. Or, to create one in your Scene, drag this into the Hierarchy. But make your own prefab out of it so you won't get your changed overridden next time you update Pool Boss.");
            return;
        }
        ...
        if (!Application.isPlaying) {
            var maxFrames = _pool.poolItems.Count;
